<?php
	...
	$Translation['AppGini forum'] = "Foro de la Comunidad de usuarios de AppGini";
	...
	$Translation['compare tables page'] = "Esta página compara las estructuras/esquemas de las tablas y campos así como fueron diseñadas en AppGini con la estructura de la base de datos actual y permite coreegir cualquier desviación o diferencia.";
	$Translation['field'] = "Campo";
	$Translation['AppGini definition'] = "Definición AppGini";
	...
	$Translation['fix field'] = "Ajuste el campo ejecutando la consulta ALTER COLUMN para que su definición sea la misma que en AppGini.";
	$Translation['fix it'] = "Corregir";
	$Translation['field update warning'] = "CUIDADO!! En algunos casos, esto podría provocar la perdida de datos, truncamiento, o corrupción de los mismos. Podría ser una mejor idea en algunas ocasiones actualizar el campo en AppGini para coincidir con la base de datos. Está decidido a continuar?";
	...
	$Translation['generated by'] = 'Esta aplicación fue generada con AppGini <VERSION> el <DATETIME>.';
