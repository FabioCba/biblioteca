			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][2]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][2]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record['2']); ?>" data-lightbox="Circulacion-Foto_Usuario"><img src="thumbnail.php?i=<?php echo urlencode($record['2']); ?>&t=Usuarios&f=Foto&v=tv" class="img-thumbnail"></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][8]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record['8']); ?>" data-lightbox="Circulacion-Portada_libro"><img src="thumbnail.php?i=<?php echo urlencode($record['8']); ?>&t=Catalogo&f=Portada&v=tv" class="img-thumbnail"></a></td>
