<?php
	...
	$Translation['upload image'] = 'Cargar archivo ';
	...
	// incCommon.php
	$Translation['not signed in']="Es usted un usuario ya registrado?";
	...
	$Translation['sign up disabled']="Lo sentimos! Regístrate está desactivado temporalmente por el administrador. Inténtelo de nuevo más tarde.";
	...
	$Translation['email']="Dirección Email";
	$Translation['group']="Grupo";
	$Translation['groups *']="Si decide inscribirse a un grupo marcado con un asterisco (*), no podrá iniciar la sesión hasta que el administrador que lo apruebe. Usted recibirá un correo electrónico cuando sea aprobado.";
	$Translation['sign up']="Registrarse aquí";

	// membership_passwordReset.php
	$Translation['password reset']="Restablecer Password";
	$Translation['password reset details']="Introduzca su nombre de usuario o su dirección de correo electrónico. A continuación, le enviaremos un enlace especial a su correo electrónico. Después de hacer clic en seguiente enlace, se le pedirá que escriba una nueva contraseña.";
	...
	$Translation['All records owned by your group'] = 'Todos los registros de propiedad del grupo';
	$Translation['All records'] = 'Todos los registros';
	$Translation['Not allowed'] = 'Acción no permitido';
	...
	$Translation['setup finished'] = '<b>Instalación terminada con éxito,!</b><br><br>Su aplicación se ha instalado correctamente.<br> He aquí algunas sugerencias para empezar a usarlo:';
	$Translation['setup next 1'] = 'Comience a utilizar la aplicación para añadir datos, o trabajar con los datos existentes, si existera alguna.';
	...
	$Translation['Lets go'] = 'Irno\'s ahora!';
	...
	$Translation['You don\'t have enough permissions to delete this record'] = 'Usted no tiene suficientes permisos para eliminar este registro';
	...
	$Translation['Update progress'] = 'Actualización en progreso';
	...
	$Translation['cant retrieve coordinates from url'] = 'Can\'t recuperar coordenadas de URL!';

	/* Added in AppGini 5.51 */
	$Translation['maintenance mode admin notification'] = 'Modo de mantenimiento activado! Lo puede desactivar desde la página del administrador.';
	$Translation['unique field error'] = 'Este valor ya existe o es inválido. Por favor asegúrese de especificar un valor único válido.';

    /* Added in AppGini 5.60 */
	$Translation['show all user records from table'] = 'Mostrar todos los registros de este usuario "<tablename>" table';
	$Translation['show all group records from table'] = 'Mostrar todos los registros de este grupo desde "<tablename>" table';
	$Translation['email this user'] = 'Enviar correo a este usuario';
	$Translation['email this group'] = 'Enviar correo a este grupo';
	$Translation['owner'] = 'Propietario';
	$Translation['created'] = 'Creado';
	$Translation['last modified'] = 'Última modificación';
	$Translation['record has no owner'] = 'Este registro no tiene propietario asignado. Puede asignar un propietario desde el área de administración.';
	$Translation['admin-only info'] = 'La información anterior se muestra porque actualmente está conectado como Super Administrador... Otros usuarios no\'t verán esto.';
	$Translation['discard changes confirm'] = 'Descartar los cambios en este registro?';

    /* Added in AppGini 5.70 */
	$Translation['hide/show columns'] = 'Ocultar/Mostrar columnas';
	$Translation['next column'] = 'Siguiente columna';
	$Translation['previous column'] = 'Columna anterior';

    /* Added in AppGini 5.72 */
	$Translation['hide all'] = 'Ocultar todo';
	$Translation['toggle'] = 'Palanca de Cambio';

    /* Added in AppGini 5.73 */
	$Translation['datetimepicker locale'] = 'en'; // Si es necesario, establezca una configuración regional para su uso en el selector de fecha y hora. Para las configuraciones regionales admitidas, escriba moment.locales () en la consola de su navegador.
	$Translation['account token theft warning'] = 'Alguien podría haber intentado acceder a su cuenta robando su token de acceso basado en cookies. Como medida de precaución, se ha desconectado y debe volver a ingresar sus credenciales de inicio de sesión para iniciar sesión.';
	
	/* Added in AppGini 5.75 */
	$Translation['rebuild fields'] = 'Puedes intentar solucionar este problema desde el área de administración : Menú de utilidades: Reconstruir campos.';
